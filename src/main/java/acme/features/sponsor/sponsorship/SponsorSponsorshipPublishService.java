...
public class SponsorSponsorshipPublishService extends AbstractService<Sponsor, Sponsorship> {
	...
	public void validate() {
		...
		hasAtLeastOneDonation = this.repository.existsDonationsBySponsorshipId(this.sponsorship.getId());
		super.state(hasAtLeastOneDonation, "*", "acme.validation.sponsorship.draftMode.message");
