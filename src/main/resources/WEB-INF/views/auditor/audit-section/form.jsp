...
<acme:form>
    ...
    <acme:form-select code="auditor.audit-section.form.label.kind" path="kind" choices="${kindChoices}" readonly="${!draftMode && id != 0}"/>
    <acme:form-integer code="auditor.audit-section.form.label.hours" path="hours" readonly="${!draftMode && id != 0}"/>
    <acme:form-textarea code="auditor.audit-section.form.label.notes" path="notes" readonly="${!draftMode && id != 0}"/>
